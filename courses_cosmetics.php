...
<head>
  ...
  <meta name="description" content="Онлайн курсы косметологии">
  <title>Курсы косметологии</title>
  ...
  <div class="container-xxl mt-5 mb-3">
    <nav
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active mt-3" aria-current="page">Косметология</li>
      </ol>
    </nav>
    <h3 class="mt-2 mb-4">Курсы дистанционного обучения косметологии</h3>

    <?php

    include_once("bd_connection.php");

    $sql = "SELECT * FROM cosmetics_cards";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body" style="margin-left: 2%; margin-right: 2%;">
            ...
            <h6 class="" align="center">Мы свяжемся с Вами в ближайшее время.</h6>
            ...
            if (isset($_POST["submit"])) {
              ...
              $subject = "Запись на курс косметологии";
              $mess = "
              <style>
              body {
          ...
          <div class='block-e'>
              ...
              <div class='text-block'>
                  <h3>Здравствуйте, {$_REQUEST['first_name']}!</h3>
                  <table>
                      <td><img src='https://cdn-icons-png.flaticon.com/512/9135/9135968.png' alt=''></td>
                      <td>
                          <p>Недавно Вы подавали заявку на покупку онлайн курса {$_REQUEST['course_name']}.<br>
                              Оплата курса производится по реквезитам. После оплаты пришлите чек, ваше ФИО и название курса
                              на почту $admin.<br>
                              После подтверждения оплаты Вам придет ссылка на диск с курсом.</p>
                      </td>
                  </table>
              </div>
          </div>
              <h1>Пользователь отправил заявку на курс косметологии</h1>
            ...
            <form style="margin-left: 5%; margin-right: 5%;" method="post">
              ...
              <div class="mb-1 mt-4">
                ...
                <select class="form-select" id="course_name" name="course_name" required>
                  ...
                  <option value="Косметолог-эстетист">Курс "Косметолог-эстетист"</option>
                  <option value="Лазерная терапия">Курс "Лазерная терапия"</option>
                  <option value="Прикладная эстетика в массаже">Курс "Прикладная эстетика в массаже"</option>
                  <option value="Аппаратная косметология 1">Курс "Аппаратная косметология 1"</option>
                  <option value="Аппаратная косметология 2 Смас лифтинг">Курс "Аппаратная косметология 2 Смас лифтинг"
                  </option>
                  <option value="Аппаратная косметология 3">Курс "Аппаратная косметология 3"</option>
                  <option value="Аппаратная косметология 4 Микроигольчатый RF-лифтинг">Курс "Аппаратная косметология 4
                    Микроигольчатый RF-лифтинг"</option>
                </select>
              </div>
              <div class="mb-1">
