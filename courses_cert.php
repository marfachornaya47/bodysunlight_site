...
<head>
  ...
  <title>Курсы с сертификатом</title>
  ...
  <div class="container-xxl mt-5 mb-3">
    <nav
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active mt-3" aria-current="page">Курсы с сертификатом</li>
      </ol>
    </nav>
    <h3 class="mt-2 mb-4">Курсы дистанционного обучения с сертификатом</h3>

    <?php

    include_once("bd_connection.php");

    $sql = "SELECT * FROM cert_cards";
            ...
            <form style="margin-left: 5%; margin-right: 5%;" method="post">
              ...
              <div class="mb-1 mt-4">
                ...
                <select class="form-select" id="course_name" name="course_name" required>
                  ...
                  <option value="Скульптурный массаж лица">Курс "Скульптурный массаж лица"</option>
                  <option value="Миофасциальный массаж лица">Курс "Миофасциальный массаж лица"</option>
                  <option value="Массаж шейно-воротниковой зоны">Курс "Массаж шейно-воротниковой зоны"</option>
                  <option value="Общий массаж тела">Курс "Общий массаж тела"</option>
                  <option value="Спа обёртывание">Курс "Спа обёртывание"</option>
                  <option value="Чистки лица">Курс "Чистки лица"</option>
                  <option value="Пилинги">Курс "Пилинги"</option>
                  <option value="Акне">Курс "Акне"</option>
                  <option value="Ультразвук в косметологии">Курс "Ультразвук в косметологии"</option>
                  <option value="РФ лифтинг в косметологии">Курс "РФ лифтинг в косметологии"</option>
                  <option value="Световая терапия в косметологии">Курс "Световая терапия в косметологии"</option>
                  <option value="Криотерапия в косметологии">Курс "Криотерапия в косметологии"</option>
                  <option value="Фарфоровая кукла">Курс "Фарфоровая кукла"</option>
                </select>
              </div>
              <div class="mb-1">
